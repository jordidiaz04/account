...
class AccountsApplicationTests {
    ...
    void testListByClientDocumentNumber() {
        ...
        var responseBody = webTestClient
                .get()
                .uri("/get/client/documentNumber/00000001")
                .exchange()
                .expectStatus().isOk()
    ...
    void testListByDebitCard() {
        ...
        var responseBody = webTestClient
                .get()
                .uri("/get/debitCard/4420652012504888")
                .exchange()
                .expectStatus().isOk()
                .returnResult(Account.class)
                .getResponseBody();
    ...
    void testGetTotalBalanceByDebitCard() {
        ...
        var responseBody = webTestClient
                .get()
                .uri("/get/totalBalance/4420652012504888")
                .exchange()
                .expectStatus().isOk()
    ...
    void testListByClientFirstNameAndLastName() {
        ...
        var responseBody = webTestClient
                .get()
                .uri("/get/client/firstName/Juan/lastName/Lopez")
                .exchange()
                .expectStatus().isOk()
                .returnResult(Account.class)
                .getResponseBody();
